...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      ...
      {
        staticClass:
          "border border-grey-light px-10 py-2 rounded-full text-sm text-black font-bold",
        attrs: { target: "_blank", href: "/animations/spinner.zip" }
      },
      [_vm._v("spinner.zip")]
    )
  ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("p", { staticClass: "my-10 test-grey-darker leading-normal" }, [
      _vm._v("\n    This spinner uses AirBnb's\n    "),
      _c(
        "a",
        {
          staticClass: "text-standard-blue font-bold",
          attrs: { href: "http://airbnb.io/lottie/#/web", target: "_blank" }
        },
        [_vm._v("Lottie")]
      ),
      _vm._v(
